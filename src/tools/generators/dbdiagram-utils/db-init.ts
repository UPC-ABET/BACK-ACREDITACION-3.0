...
export class Init1778968464894 implements MigrationInterface {
	name = 'Init1778968464894';
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`CREATE TABLE "ifc"."notification_log" ("id" SERIAL NOT NULL, "extra" jsonb NOT NULL DEFAULT '{}'::jsonb, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE, "course_id" integer NOT NULL, "academic_period_id" integer NOT NULL, "notified_staff_id" integer NOT NULL, "notifier_staff_id" integer NOT NULL, "user_id" integer NOT NULL, "sent_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_6f761cfbbd064e0f326960877d6" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE TABLE "evaluation"."project_students" ("id" SERIAL NOT NULL, "extra" jsonb NOT NULL DEFAULT '{}'::jsonb, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE, "project_id" integer NOT NULL, "student_section_enrollment_id" integer NOT NULL, "evaluator_type_id" integer NOT NULL, CONSTRAINT "PK_4c91cdbc4130ba8bba12d23a28c" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE TABLE "evaluation"."rubrics" ("id" SERIAL NOT NULL, "extra" jsonb NOT NULL DEFAULT '{}'::jsonb, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE, "rubric_type_id" integer NOT NULL, "segment_type_id" integer NOT NULL, "study_plan_course_id" integer NOT NULL, CONSTRAINT "PK_3dfcdc7f63f3fa048ebe0293a90" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
			`CREATE TABLE "evaluation"."rubric_outcome_criterias" ("id" SERIAL NOT NULL, "extra" jsonb NOT NULL DEFAULT '{}'::jsonb, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE, "rubric_id" integer NOT NULL, "outcome_id" integer NOT NULL, "criteria" character varying(1000) NOT NULL, CONSTRAINT "PK_9999fa099b8ae7a9b6325b4a787" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
			`CREATE TABLE "evaluation"."rubric_question_criterias" ("id" SERIAL NOT NULL, "extra" jsonb NOT NULL DEFAULT '{}'::jsonb, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE, "rubric_question_id" integer NOT NULL, "rubric_scale_id" integer NOT NULL, "criteria" jsonb NOT NULL DEFAULT '{}'::jsonb, "min_value" numeric(12,6) NOT NULL, "max_value" numeric(12,6) NOT NULL, CONSTRAINT "PK_104ee798bfc899e19859348ea08" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
			`CREATE TABLE "evaluation"."rubric_scores" ("id" SERIAL NOT NULL, "extra" jsonb NOT NULL DEFAULT '{}'::jsonb, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE, "evaluation_id" integer NOT NULL, "rubric_outcome_criteria_id" integer NOT NULL, "rubric_question_criteria_id" integer NOT NULL, "score" numeric(12,6) NOT NULL, "commentaries" jsonb DEFAULT '{}'::jsonb, CONSTRAINT "PK_35eb0094940cd089113bae42d34" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "improvement"."findings" ADD CONSTRAINT "FK_f79e2e5a7c506d75cbf6075ad49" FOREIGN KEY ("course_id") REFERENCES "academic"."courses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "improvement"."findings" ADD CONSTRAINT "FK_357564f29027bc0db42b0aef438" FOREIGN KEY ("academic_period_id") REFERENCES "academic"."academic_periods"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "evidence"."ifcs" ADD CONSTRAINT "FK_f8379cc7867197b7c010101303e" FOREIGN KEY ("course_id") REFERENCES "academic"."courses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "evidence"."ifcs" ADD CONSTRAINT "FK_f791553002e9c0e2be408dac702" FOREIGN KEY ("academic_period_id") REFERENCES "academic"."academic_periods"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "ifc"."notification_log" ADD CONSTRAINT "FK_1109a56056ebd7ee494e86aba39" FOREIGN KEY ("course_id") REFERENCES "academic"."courses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "ifc"."notification_log" ADD CONSTRAINT "FK_76c0df2846ed8ff6cdefc1188df" FOREIGN KEY ("academic_period_id") REFERENCES "academic"."academic_periods"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "ifc"."notification_log" ADD CONSTRAINT "FK_b07d0dd1218b75c3e5250395ba9" FOREIGN KEY ("notified_staff_id") REFERENCES "organization"."staff"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "ifc"."notification_log" ADD CONSTRAINT "FK_ac22691ea5641eaf42ddbc6aea2" FOREIGN KEY ("notifier_staff_id") REFERENCES "organization"."staff"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "ifc"."notification_log" ADD CONSTRAINT "FK_2318594e750647311b24da4ae5f" FOREIGN KEY ("user_id") REFERENCES "organization"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "ifc"."notification_configs" ADD CONSTRAINT "FK_2df53b34dedb845d370bdb0e62e" FOREIGN KEY ("school_id") REFERENCES "organization"."schools"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "ifc"."notification_configs" ADD CONSTRAINT "FK_fa5d5f0140df893316fd9c67c58" FOREIGN KEY ("academic_period_id") REFERENCES "academic"."academic_periods"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "evaluation"."rubric_outcome_criterias" ADD CONSTRAINT "FK_71f94924a53684210d9c5c18eb0" FOREIGN KEY ("rubric_id") REFERENCES "evaluation"."rubrics"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "evaluation"."rubric_outcome_criterias" ADD CONSTRAINT "FK_0c63b3ae8243bc08499b7875c2d" FOREIGN KEY ("outcome_id") REFERENCES "accreditation"."outcomes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "evaluation"."rubric_scores" ADD CONSTRAINT "FK_c8e07c409443fb27cd779a61a5d" FOREIGN KEY ("rubric_outcome_criteria_id") REFERENCES "evaluation"."rubric_outcome_criterias"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "evaluation"."rubric_scales" ADD CONSTRAINT "FK_fd8b696b115497db26fecdf133c" FOREIGN KEY ("rubric_id") REFERENCES "evaluation"."rubrics"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`ALTER TABLE "evaluation"."rubric_scales" DROP CONSTRAINT "FK_fd8b696b115497db26fecdf133c"`);
		...
		await queryRunner.query(`ALTER TABLE "evaluation"."rubric_scores" DROP CONSTRAINT "FK_c8e07c409443fb27cd779a61a5d"`);
		await queryRunner.query(`ALTER TABLE "evaluation"."rubric_scores" DROP CONSTRAINT "FK_6b7a0e963995aac32b706b65b1e"`);
		await queryRunner.query(`ALTER TABLE "evaluation"."rubric_outcome_criterias" DROP CONSTRAINT "FK_0c63b3ae8243bc08499b7875c2d"`);
		await queryRunner.query(`ALTER TABLE "evaluation"."rubric_outcome_criterias" DROP CONSTRAINT "FK_71f94924a53684210d9c5c18eb0"`);
		...
		await queryRunner.query(`ALTER TABLE "ifc"."notification_configs" DROP CONSTRAINT "FK_fa5d5f0140df893316fd9c67c58"`);
		await queryRunner.query(`ALTER TABLE "ifc"."notification_configs" DROP CONSTRAINT "FK_2df53b34dedb845d370bdb0e62e"`);
		...
		await queryRunner.query(`ALTER TABLE "ifc"."notification_log" DROP CONSTRAINT "FK_2318594e750647311b24da4ae5f"`);
		await queryRunner.query(`ALTER TABLE "ifc"."notification_log" DROP CONSTRAINT "FK_ac22691ea5641eaf42ddbc6aea2"`);
		await queryRunner.query(`ALTER TABLE "ifc"."notification_log" DROP CONSTRAINT "FK_b07d0dd1218b75c3e5250395ba9"`);
		await queryRunner.query(`ALTER TABLE "ifc"."notification_log" DROP CONSTRAINT "FK_76c0df2846ed8ff6cdefc1188df"`);
		await queryRunner.query(`ALTER TABLE "ifc"."notification_log" DROP CONSTRAINT "FK_1109a56056ebd7ee494e86aba39"`);
		...
		await queryRunner.query(`ALTER TABLE "evidence"."ifcs" DROP CONSTRAINT "FK_f791553002e9c0e2be408dac702"`);
		await queryRunner.query(`ALTER TABLE "evidence"."ifcs" DROP CONSTRAINT "FK_f8379cc7867197b7c010101303e"`);
		...
		await queryRunner.query(`ALTER TABLE "improvement"."findings" DROP CONSTRAINT "FK_357564f29027bc0db42b0aef438"`);
		await queryRunner.query(`ALTER TABLE "improvement"."findings" DROP CONSTRAINT "FK_f79e2e5a7c506d75cbf6075ad49"`);
