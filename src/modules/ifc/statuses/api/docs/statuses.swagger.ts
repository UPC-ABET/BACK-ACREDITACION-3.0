...
export const SwaggerStatusCreate = () => HttpMethodWithSwagger({ ...cfg.operation.create, body: CreateStatusDto });

export const SwaggerStatusUpdate = () => HttpMethodWithSwagger({ ...cfg.operation.update, body: UpdateStatusDto });
...
export const SwaggerStatusGetByFilters = () => HttpMethodWithSwagger({ ...cfg.operation.getByFilters, body: FilterStatusDto });
