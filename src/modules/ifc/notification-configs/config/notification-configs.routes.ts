export const notificationConfigsRoutes = {
	notification_configs: {
		...
		operation: {
			create: { method: 'POST', route: '/create', summary: 'Registrar configuracion de notificacion IFC' },
			update: { method: 'PUT', route: '/update/:id', summary: 'Actualizar configuracion de notificacion IFC' },
			delete: { method: 'DELETE', route: '/delete/:id', summary: 'Eliminar configuracion de notificacion IFC' },
