...
export const SwaggerAcademicPeriodController = () => ControllerWithTags({ tag: cfg.tag, route: cfg.route });

export const SwaggerAcademicPeriodCreate = () => HttpMethodWithSwagger({ ...cfg.operation.create, body: CreateAcademicPeriodDto });

export const SwaggerAcademicPeriodUpdate = () => HttpMethodWithSwagger({ ...cfg.operation.update, body: UpdateAcademicPeriodDto });
...
export const SwaggerAcademicPeriodGetByFilters = () => HttpMethodWithSwagger({ ...cfg.operation.getByFilters, body: FilterAcademicPeriodDto });
