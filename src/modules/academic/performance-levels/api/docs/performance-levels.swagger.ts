...
export const SwaggerPerformanceLevelController = () => ControllerWithTags({ tag: cfg.tag, route: cfg.route });

export const SwaggerPerformanceLevelCreate = () => HttpMethodWithSwagger({ ...cfg.operation.create, body: CreatePerformanceLevelDto });

export const SwaggerPerformanceLevelUpdate = () => HttpMethodWithSwagger({ ...cfg.operation.update, body: UpdatePerformanceLevelDto });
...
export const SwaggerPerformanceLevelGetByFilters = () => HttpMethodWithSwagger({ ...cfg.operation.getByFilters, body: FilterPerformanceLevelDto });
