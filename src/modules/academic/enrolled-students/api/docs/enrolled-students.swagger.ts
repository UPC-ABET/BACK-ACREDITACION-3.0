...
export const SwaggerEnrolledStudentController = () => ControllerWithTags({ tag: cfg.tag, route: cfg.route });

export const SwaggerEnrolledStudentCreate = () => HttpMethodWithSwagger({ ...cfg.operation.create, body: CreateEnrolledStudentDto });

export const SwaggerEnrolledStudentUpdate = () => HttpMethodWithSwagger({ ...cfg.operation.update, body: UpdateEnrolledStudentDto });
...
export const SwaggerEnrolledStudentGetByFilters = () => HttpMethodWithSwagger({ ...cfg.operation.getByFilters, body: FilterEnrolledStudentDto });
