...
export const SwaggerCourseSectionController = () => ControllerWithTags({ tag: cfg.tag, route: cfg.route });

export const SwaggerCourseSectionCreate = () => HttpMethodWithSwagger({ ...cfg.operation.create, body: CreateCourseSectionDto });

export const SwaggerCourseSectionUpdate = () => HttpMethodWithSwagger({ ...cfg.operation.update, body: UpdateCourseSectionDto });
...
export const SwaggerCourseSectionGetByFilters = () => HttpMethodWithSwagger({ ...cfg.operation.getByFilters, body: FilterCourseSectionDto });
