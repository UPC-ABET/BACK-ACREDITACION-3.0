...
import { projectsUploadRoutes } from '../config/projects-upload.routes';
import { ProjectsUploadDto, RollbackUploadDto } from '../model/projects-upload.dtos';
import { XLSX_CONTENT_TYPE } from 'src/shared/constants/mime-types';
import { PERMISSION_ACTIONS, PERMISSION_MODULES } from 'src/shared/constants/permission-modules';

const routes = projectsUploadRoutes.projects_upload;

@ApiTags(routes.tag)
@Controller(routes.route)
export class ProjectsUploadController {
	constructor(private readonly service: ProjectsUploadService) {}
