...
export type { ProfessorRow, RowValidationResult, UploadResult } from './professors-upload.types';
export { splitProfessorName, DOCENTE_POSITION_CODE } from './professors-upload.types';

export class ProfessorsUploadDto {
