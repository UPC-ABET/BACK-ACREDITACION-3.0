...
import { professorsUploadRoutes } from '../config/professors-upload.routes';
import { ProfessorsUploadDto, RollbackUploadDto } from '../model/professors-upload.dtos';

const routes = professorsUploadRoutes.professors_upload;

@ApiTags(routes.tag)
@Controller(routes.route)
export class ProfessorsUploadController {
	constructor(private readonly service: ProfessorsUploadService) {}
	...
	async upload(@UploadedFile() file: Express.Multer.File, @Body() dto: ProfessorsUploadDto) {
