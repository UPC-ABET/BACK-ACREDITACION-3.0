...
import { SectionsUploadDto, RollbackUploadDto } from '../model/sections-upload.dtos';
...
export class SectionsUploadController {
	constructor(private readonly service: SectionsUploadService) {}
