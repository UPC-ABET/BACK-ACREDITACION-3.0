...
import { staffUploadRoutes } from '../config/staff-upload.routes';
import { StaffUploadDto, RollbackUploadDto } from '../model/staff-upload.dtos';
import { XLSX_CONTENT_TYPE } from 'src/shared/constants/mime-types';

const routes = staffUploadRoutes.staff_upload;
...
export class StaffUploadController {
	constructor(private readonly service: StaffUploadService) {}
