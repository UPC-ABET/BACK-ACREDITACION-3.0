...
import { articulationUploadRoutes } from '../config/articulation-upload.routes';
import { ArticulationUploadDto, RollbackUploadDto } from '../model/articulation-upload.dtos';
import { XLSX_CONTENT_TYPE } from 'src/shared/constants/mime-types';

const routes = articulationUploadRoutes.articulation_upload;

const ADMIN_MODULE = 'ADMIN';

@ApiTags(routes.tag)
@Controller(routes.route)
export class ArticulationUploadController {
	constructor(private readonly service: ArticulationUploadService) {}
