...
import { RubricsUploadService } from './rubrics-upload.service';
import { rubricsUploadRoutes } from '../config/rubrics-upload.routes';
import { RubricsUploadDto, RollbackUploadDto } from '../model/rubrics-upload.dtos';
import { XLSX_CONTENT_TYPE } from 'src/shared/constants/mime-types';
import { PERMISSION_ACTIONS, PERMISSION_MODULES } from 'src/shared/constants/permission-modules';

const routes = rubricsUploadRoutes.rubrics_upload;

@ApiTags(routes.tag)
@Controller(routes.route)
export class RubricsUploadController {
	constructor(private readonly service: RubricsUploadService) {}
