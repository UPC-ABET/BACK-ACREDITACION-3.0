...
export const SwaggerProjectEvaluatorController = () => ControllerWithTags({ tag: cfg.tag, route: cfg.route });

export const SwaggerProjectEvaluatorCreate = () => HttpMethodWithSwagger({ ...cfg.operation.create, body: CreateProjectEvaluatorDto });

export const SwaggerProjectEvaluatorUpdate = () => HttpMethodWithSwagger({ ...cfg.operation.update, body: UpdateProjectEvaluatorDto });
...
export const SwaggerProjectEvaluatorGetByFilters = () => HttpMethodWithSwagger({ ...cfg.operation.getByFilters, body: FilterProjectEvaluatorDto });
