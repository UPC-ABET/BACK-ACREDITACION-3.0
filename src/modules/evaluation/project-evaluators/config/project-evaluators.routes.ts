export const projectEvaluatorsRoutes = {
	project_evaluators: {
		...
		operation: {
			...
			update: { method: 'PATCH', route: '/update/:id', summary: 'Actualizar evaluador de proyecto' },
			...
			getByFilters: { method: 'POST', route: '/get-by-filters', summary: 'Buscar evaluadores de proyecto' },
		},
	},
};
