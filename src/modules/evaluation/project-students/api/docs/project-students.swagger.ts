...
export const SwaggerProjectStudentController = () => ControllerWithTags({ tag: cfg.tag, route: cfg.route });

export const SwaggerProjectStudentCreate = () => HttpMethodWithSwagger({ ...cfg.operation.create, body: CreateProjectStudentDto });

export const SwaggerProjectStudentUpdate = () => HttpMethodWithSwagger({ ...cfg.operation.update, body: UpdateProjectStudentDto });
...
export const SwaggerProjectStudentGetByFilters = () => HttpMethodWithSwagger({ ...cfg.operation.getByFilters, body: FilterProjectStudentDto });
