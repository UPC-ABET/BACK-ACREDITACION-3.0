...
export const SwaggerCommissionController = () => ControllerWithTags({ tag: cfg.tag, route: cfg.route });

export const SwaggerCommissionCreate = () => HttpMethodWithSwagger({ ...cfg.operation.create, body: CreateCommissionDto });

export const SwaggerCommissionUpdate = () => HttpMethodWithSwagger({ ...cfg.operation.update, body: UpdateCommissionDto });
...
export const SwaggerCommissionGetByFilters = () => HttpMethodWithSwagger({ ...cfg.operation.getByFilters, body: FilterCommissionDto });
