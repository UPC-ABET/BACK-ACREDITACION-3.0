...
export const SwaggerProgramCommissionCreate = () =>
	HttpMethodWithSwagger({ ...cfg.operation.create, body: CreateProgramCommissionDto });

export const SwaggerProgramCommissionUpdate = () =>
	HttpMethodWithSwagger({ ...cfg.operation.update, body: UpdateProgramCommissionDto });
