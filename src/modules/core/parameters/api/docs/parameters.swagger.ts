...
export const SwaggerParameterController = () => ControllerWithTags({ tag: cfg.tag, route: cfg.route });

export const SwaggerParameterCreate = () => HttpMethodWithSwagger({ ...cfg.operation.create, body: CreateParameterDto });

export const SwaggerParameterUpdate = () => HttpMethodWithSwagger({ ...cfg.operation.update, body: UpdateParameterDto });
...
export const SwaggerParameterGetByFilters = () => HttpMethodWithSwagger({ ...cfg.operation.getByFilters, body: FilterParameterDto });
