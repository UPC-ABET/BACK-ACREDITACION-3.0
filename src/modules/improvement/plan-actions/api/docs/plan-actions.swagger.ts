...
export const SwaggerPlanActionController = () => ControllerWithTags({ tag: cfg.tag, route: cfg.route });

export const SwaggerPlanActionCreate = () => HttpMethodWithSwagger({ ...cfg.operation.create, body: CreatePlanActionDto });

export const SwaggerPlanActionUpdate = () => HttpMethodWithSwagger({ ...cfg.operation.update, body: UpdatePlanActionDto });
...
export const SwaggerPlanActionGetByFilters = () => HttpMethodWithSwagger({ ...cfg.operation.getByFilters, body: FilterPlanActionDto });
