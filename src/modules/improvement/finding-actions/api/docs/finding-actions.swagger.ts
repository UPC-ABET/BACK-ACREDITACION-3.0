...
export const SwaggerFindingActionController = () => ControllerWithTags({ tag: cfg.tag, route: cfg.route });

export const SwaggerFindingActionCreate = () => HttpMethodWithSwagger({ ...cfg.operation.create, body: CreateFindingActionDto });

export const SwaggerFindingActionUpdate = () => HttpMethodWithSwagger({ ...cfg.operation.update, body: UpdateFindingActionDto });
...
export const SwaggerFindingActionGetByFilters = () => HttpMethodWithSwagger({ ...cfg.operation.getByFilters, body: FilterFindingActionDto });
