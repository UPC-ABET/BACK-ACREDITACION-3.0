export const lcfcValidationStrings = {
	error: {
		tokenNotFound: 'error.survey.lcfc.tokenNotFound',
		tokenExpired: 'error.survey.lcfc.tokenExpired',
		alreadyCompleted: 'error.survey.lcfc.alreadyCompleted',
