...
// ── CONFIG ──
export const SwaggerLcfcConfigGenerate = () => HttpMethodWithSwagger({ ...cfg.config.generate, body: GenerateLcfcConfigDto });
export const SwaggerLcfcConfigGetAll = () => HttpMethodWithSwagger(cfg.config.getAll);
export const SwaggerLcfcConfigGetByFilters = () => HttpMethodWithSwagger({ ...cfg.config.getByFilters, body: FilterLcfcConfigDto });
export const SwaggerLcfcConfigUpdateStatus = () => HttpMethodWithSwagger({ ...cfg.config.updateStatus, body: UpdateLcfcConfigStatusDto });
...
export const SwaggerLcfcSurveyComplete = () => HttpMethodWithSwagger({ ...cfg.survey.complete, body: CompleteLcfcSurveyDto });

// ── DASHBOARD ──
export const SwaggerLcfcDashboard = () => HttpMethodWithSwagger({ ...cfg.dashboard.get, body: DashboardLcfcDto });
