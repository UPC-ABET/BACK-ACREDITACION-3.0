...
export const SwaggerNotificationController = () =>
	ControllerWithTags({ tag: cfg.tag, route: cfg.route });

export const SwaggerNotificationCreate = () =>
	HttpMethodWithSwagger({ ...cfg.operation.create, body: CreateNotificationDto });

export const SwaggerNotificationUpdate = () =>
	HttpMethodWithSwagger({ ...cfg.operation.update, body: UpdateNotificationDto });
...
export const SwaggerNotificationGetByFilters = () =>
	HttpMethodWithSwagger({ ...cfg.operation.getByFilters, body: FilterNotificationDto });
