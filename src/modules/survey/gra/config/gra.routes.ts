export const graRoutes = {
	...
	config: {
		create: { method: 'POST', route: 'config/create', summary: 'Crear configuración de competencia GRA' },
		getAll: { method: 'GET', route: 'config/get-all', summary: 'Listar todas las configuraciones GRA' },
		getByFilters: { method: 'POST', route: 'config/get-by-filters', summary: 'Filtrar configuraciones GRA' },
	...
	notification: {
		...
		listStudents: { method: 'POST', route: 'notification/list-students', summary: 'Listar estudiantes con estado de notificación GRA' },
		delete: { method: 'DELETE', route: 'notification/delete/:id', summary: 'Eliminar estudiante de la lista GRA' },
	},
	email: {
		send: { method: 'POST', route: 'email/send', summary: 'Enviar encuestas GRA por correo a estudiantes pendientes' },
	},
	token: {
		validate: { method: 'GET', route: 'token/validate/:token', summary: 'Validar token de encuesta GRA (sin autenticación)' },
	},
	survey: {
