...
export const SwaggerGraConfigGetById = () =>
	HttpMethodWithSwagger({ ...cfg.config.getById, params: [{ name: 'id', description: 'ID de la configuración GRA', type: Number }] });
...
export const SwaggerGraConfigDelete = () =>
	HttpMethodWithSwagger({ ...cfg.config.delete, params: [{ name: 'id', description: 'ID de la configuración GRA', type: Number }] });
...
export const SwaggerGraNotificationDelete = () =>
	HttpMethodWithSwagger({ ...cfg.notification.delete, params: [{ name: 'id', description: 'ID de la notificación GRA', type: Number }] });
...
export const SwaggerGraTokenValidate = () =>
	HttpMethodWithSwagger({ ...cfg.token.validate, params: [{ name: 'token', description: 'Token UUID de la encuesta GRA', type: String }] });
