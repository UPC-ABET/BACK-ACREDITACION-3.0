...
export const SwaggerOutcomeConfigCreate = () =>
	HttpMethodWithSwagger({ ...cfg.operation.create, body: CreateOutcomeConfigDto });

export const SwaggerOutcomeConfigUpdate = () =>
	HttpMethodWithSwagger({ ...cfg.operation.update, body: UpdateOutcomeConfigDto });
...
export const SwaggerOutcomeConfigGetByFilters = () =>
	HttpMethodWithSwagger({ ...cfg.operation.getByFilters, body: FilterOutcomeConfigDto });
