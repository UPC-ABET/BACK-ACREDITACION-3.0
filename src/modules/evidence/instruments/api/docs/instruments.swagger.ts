...
export const SwaggerInstrumentController = () => ControllerWithTags({ tag: cfg.tag, route: cfg.route });

export const SwaggerInstrumentCreate = () => HttpMethodWithSwagger({ ...cfg.operation.create, body: CreateInstrumentDto });

export const SwaggerInstrumentUpdate = () => HttpMethodWithSwagger({ ...cfg.operation.update, body: UpdateInstrumentDto });
...
export const SwaggerInstrumentGetByFilters = () => HttpMethodWithSwagger({ ...cfg.operation.getByFilters, body: FilterInstrumentDto });
