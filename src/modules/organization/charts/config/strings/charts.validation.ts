export const chartsValidationStrings = {
	error: {
		...
		staffNotFound: 'error.chart.staffNotFound',
		entityTypeInvalid: 'error.chart.entityTypeInvalid',
	...
	result: {
		...
		maintenanceCreateFailed: 'error.chart.maintenanceCreateFailed',
		maintenanceUpdateFailed: 'error.chart.maintenanceUpdateFailed',
		maintenanceDeleteFailed: 'error.chart.maintenanceDeleteFailed',
	},
};
