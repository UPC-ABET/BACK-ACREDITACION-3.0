...
export class AddCompetencyScopeToRubricsUpload1783034214133 implements MigrationInterface {
	name = 'AddCompetencyScopeToRubricsUpload1783034214133';
...
$fn$;
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		// Restore previous version (grade-type/EB-based Capstone detection, no competency scope)
		await queryRunner.query(`
CREATE OR REPLACE FUNCTION audit.fn_upload_rubrics(
	p_rows               jsonb,
	p_academic_period_id integer,
