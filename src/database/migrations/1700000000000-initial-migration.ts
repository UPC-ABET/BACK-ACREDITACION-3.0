...
`);
		...
		// ── portfolio.project_applications ────────────────────────────────────
		await queryRunner.query(`
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(`DROP TABLE IF EXISTS "portfolio"."project_applications"`);
		await queryRunner.query(`DROP TABLE IF EXISTS "portfolio"."projects"`);
		await queryRunner.query(`DROP TABLE IF EXISTS "portfolio"."research_lines"`);
		await queryRunner.query(`DROP TABLE IF EXISTS "portfolio"."companies"`);
		await queryRunner.query(`DROP SCHEMA IF EXISTS "portfolio"`);
