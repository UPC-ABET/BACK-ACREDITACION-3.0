...
runTenantSeed('core type catalogs', async (tenantDataSource) => {
	const typeGroupRows: Array<[string, string, string]> = [
		...
		['TG802', i18n('Estado de accion', 'Action state'), i18n('Estados de acciones de mejora', 'Improvement action states')],
		['TG803', i18n('Estado de hallazgo', 'Finding state'), i18n('Estados de hallazgos de mejora', 'Improvement finding states')],
	...
	const typeRows: Array<[string, string, string, string, string]> = [
		...
		['TG601', 'TG601-T003', i18n('Practicas Pre-Profesionales', 'Pre-Professional Internships'), i18n('Encuesta PPP a estudiantes en practicas', 'PPP survey for students in internships'), '{"code":"PPP"}'],
		...
		['TG802', 'TG802-T003', i18n('Completada', 'Completed'), i18n('Accion completada', 'Completed action'), '{}'],
