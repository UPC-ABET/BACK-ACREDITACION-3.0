...
export async function loadTypes(tenantDataSource: DataSource) {
	...
	const typeRows: Array<[string, string, string, string, string]> = [
		...
		[
			'TG501',
			'TG501-T001',
			i18n('Docente', 'Teacher'),
			i18n('Constituyente docente', 'Teacher constituent'),
			'{}',
		],
		[
			'TG501',
			'TG501-T002',
			i18n('Estudiante', 'Student'),
			i18n('Constituyente estudiante', 'Student constituent'),
			'{}',
		],
		[
			'TG501',
			'TG501-T003',
			i18n('Empleador', 'Employer'),
			i18n('Constituyente empleador', 'Employer constituent'),
			'{}',
		],
		[
			'TG501',
			'TG501-T004',
			i18n('Graduados', 'Graduates'),
			i18n('Constituyente graduados', 'Graduates constituent'),
			'{}',
		],
		[
			'TG601',
