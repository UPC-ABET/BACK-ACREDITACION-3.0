	...
	await tenantDataSource.query(`
		...
		JOIN (
			VALUES
				...
				('TG601', 'TG601-T003', 'Practicas Pre-Profesionales', 'Encuesta PPP a estudiantes en practicas', '{"code":"PPP"}'::jsonb),
				('TG601', 'TG601-T004', 'Logro de Fin de Ciclo', 'Encuesta LCFC por curso y ciclo', '{"code":"LCFC"}'::jsonb),
