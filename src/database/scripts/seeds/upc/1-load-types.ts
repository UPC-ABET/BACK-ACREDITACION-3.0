...
runTenantSeed('core type catalogs', async (tenantDataSource) => {
	const typeGroupRows: Array<[string, string, string]> = [
		...
		[
			'TG902',
			i18n('Nivel de organigrama', 'Org chart level'),
			i18n('Niveles de estructura organizacional', 'Organizational structure levels'),
		],
		[
			'TG903',
	...
	const typeRows: Array<[string, string, string, string, string]> = [
		...
		[
			'TG301',
			'TG301-T001',
			i18n('Comision de programa', 'Program commission'),
			i18n('Comision de acreditacion de programa', 'Program accreditation commission'),
			'{}',
		],
		[
			'TG302',
		...
		[
			'TG601',
			'TG601-T001',
			i18n('Satisfaccion estudiantil', 'Student satisfaction'),
			i18n('Encuesta a estudiantes', 'Student survey'),
			'{}',
		],
		[
			'TG601',
			'TG601-T002',
			i18n('Egresados', 'Graduates'),
			i18n('Encuesta a egresados', 'Graduate survey'),
			'{}',
		],
		[
			'TG601',
		...
		[
			'TG901',
			'TG901-T001',
			i18n('Administrador', 'Administrator'),
			i18n('Administrador del sistema', 'System administrator'),
			'{}',
		],
		[
			'TG901',
			'TG901-T002',
			i18n('Coordinador de calidad', 'Quality coordinator'),
			i18n('Coordinador de calidad academica', 'Academic quality coordinator'),
			'{}',
		],
		[
			'TG901',
			...
			i18n('Docente del programa', 'Program professor'),
			'{}',
		],
		[
			'TG902',
			...
			i18n('Nivel decano', 'Dean level'),
			'{"level":1}',
		],
		[
			'TG902',
			'TG902-T002',
			i18n('Director de Escuela', 'School Director'),
			i18n('Nivel director de escuela', 'School Director level'),
			'{"level":2}',
		],
		[
			'TG902',
			'TG902-T003',
			i18n('Coordinador de Carrera', 'Program Coordinator'),
			i18n('Nivel coordinador de carrera', 'Program Coordinator level'),
			'{"level":3}',
		],
		[
			'TG902',
			'TG902-T004',
			i18n('Coordinador de Area', 'Area Coordinator'),
			i18n('Nivel coordinador de area', 'Area Coordinator level'),
			'{"level":4}',
		],
		[
			'TG902',
			'TG902-T005',
			i18n('Coordinador de Subarea', 'Subarea Coordinator'),
			i18n('Nivel coordinador de subarea', 'Subarea Coordinator level'),
			'{"level":5}',
		],
		[
			'TG902',
			'TG902-T006',
			i18n('Coordinador de Curso', 'Course Coordinator'),
			i18n('Nivel coordinador de curso', 'Course Coordinator level'),
			'{"level":6}',
		],
		[
			'TG903',
